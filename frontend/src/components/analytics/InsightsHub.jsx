...
const CLVDashboard = React.lazy(() => import('./CLVDashboard'));
  ...
  return (
    <div style={{ padding: '30px', fontFamily: 'system-ui, -apple-system, sans-serif', background: '#f9fafb', minHeight: 'calc(100vh - 140px)' }}>
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 700, color: '#111827', margin: '0 0 4px' }}>Insights</h1>
        <p style={{ color: '#6b7280', margin: '0 0 20px', fontSize: '14px' }}>
          Revenue analytics, feature adoption trends, and customer lifetime value analysis.
        </p>

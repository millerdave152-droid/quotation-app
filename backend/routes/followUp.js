...
router.post('/quotations/:id/follow-ups', authenticate, asyncHandler(async (req, res) => {
  const { id } = req.params;
...
// Cancel a follow-up
router.delete('/follow-ups/:id', authenticate, asyncHandler(async (req, res) => {
  const { id } = req.params;
...
router.post('/quotations/:id/interactions', authenticate, asyncHandler(async (req, res) => {
  const { id } = req.params;
...
router.get('/quotations/:id/interactions', authenticate, asyncHandler(async (req, res) => {
  const { id } = req.params;
...
router.get('/follow-ups/stale-quotes', authenticate, asyncHandler(async (req, res) => {
...
router.get('/follow-ups/stats', authenticate, asyncHandler(async (req, res) => {

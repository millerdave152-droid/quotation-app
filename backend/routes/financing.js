...
function init({ financingService }) {
  ...
  router.get('/plans', async (req, res) => {
    try {
      ...
      console.error('[Financing] Get plans error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.get('/plans/:planId/calculate', async (req, res) => {
    try {
      ...
      console.error('[Financing] Calculate plan error:', error);
  ...
  router.post('/apply', async (req, res) => {
    try {
      ...
      if (!planId || !customerId) {
        return res.status(400).json({
          success: false,
          error: 'planId and customerId are required',
        });
      }
  ...
  router.get('/applications/:id', async (req, res) => {
    try {
      ...
      console.error('[Financing] Get application error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
   ...
   * Body: { notes? }
   */
  router.post('/applications/:id/manual-approve', async (req, res) => {
    try {
      const { id } = req.params;
      ...
      if (appRows.length === 0) {
        return res.status(404).json({
          success: false,
          error: 'Application not found or not in pending/more_info status',
        });
      }
      ...
      console.error('[Financing] Manual approve error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
   ...
   * Body: { reason }
   */
  router.post('/applications/:id/manual-decline', async (req, res) => {
    try {
      const { id } = req.params;
      ...
      console.error('[Financing] Manual decline error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
  ...
  router.get('/agreements/:id', async (req, res) => {
    try {
      ...
      console.error('[Financing] Get agreement error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
  ...
  router.get('/customer/:customerId', async (req, res) => {
    try {
      ...
      console.error('[Financing] Get customer financing error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.post('/agreements/:agreementId/payments', async (req, res) => {
    try {
      ...
      console.error('[Financing] Record payment error:', error);
      res.status(400).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.get('/agreements/:agreementId/payoff', async (req, res) => {
    try {
      const { agreementId } = req.params;
      ...
      console.error('[Financing] Calculate payoff error:', error);
      res.status(400).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.post('/agreements/:agreementId/payoff', async (req, res) => {
    try {
      const { agreementId } = req.params;
      ...
      console.error('[Financing] Process payoff error:', error);
      res.status(400).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.post('/link-transaction', async (req, res) => {
    try {
      ...
      if (!transactionId || !applicationId) {
        return res.status(400).json({
          success: false,
          error: 'transactionId and applicationId are required',
        });
      }
      ...
      console.error('[Financing] Link transaction error:', error);
      res.status(400).json({
        success: false,
        error: error.message,
      });
  ...
  router.post('/webhooks/affirm', async (req, res) => {
    try {
      ...
      console.error('[Financing] Affirm webhook error:', error);
  ...
  router.post('/webhooks/klarna', async (req, res) => {
    try {
      ...
      console.error('[Financing] Klarna webhook error:', error);
      res.status(200).json({
        success: false,
        error: error.message,
      });
  ...
  router.post('/webhooks/synchrony', async (req, res) => {
    try {
      ...
      console.error('[Financing] Synchrony webhook error:', error);
      res.status(200).json({
        success: false,
        error: error.message,
      });
  ...
  router.get('/admin/applications', async (req, res) => {
    try {
      ...
      console.error('[Financing] Admin list applications error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.get('/admin/agreements', async (req, res) => {
    try {
      ...
      console.error('[Financing] Admin list agreements error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.get('/admin/upcoming-payments', async (req, res) => {
    try {
      ...
      console.error('[Financing] Admin upcoming payments error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
  ...
  router.get('/admin/overdue', async (req, res) => {
    try {
      ...
      console.error('[Financing] Admin overdue payments error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
  ...
  router.post('/admin/applications/:id/approve', async (req, res) => {
    try {
      ...
      if (appRows.length === 0) {
        return res.status(404).json({
          success: false,
          error: 'Application not found or not pending',
        });
      }
      ...
      console.error('[Financing] Admin approve error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
   ...
   */
  router.post('/admin/applications/:id/decline', async (req, res) => {
    try {
      const { id } = req.params;
      ...
      console.error('[Financing] Admin decline error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
  ...
  router.get('/admin/collections', async (req, res) => {
    try {
      ...
      console.error('[Financing] Admin collections error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
  ...
  router.get('/admin/dashboard', async (req, res) => {
    try {
      ...
      console.error('[Financing] Admin dashboard error:', error);
      res.status(500).json({
        success: false,
        error: error.message,
      });
